...
//        val email = prefs.getString("email", null)
  //      val password = prefs.getString("password", null)
   ...
   val actionbar = supportActionBar
    ...
    Toast.makeText(this@UsersList, e.toString(), Toast.LENGTH_SHORT).show()
...
//    glacial.pk/GlacialAppPortalApis/labtestcontents.php?var={"email":"03316151716","password":"admin"}
    ...
    fun populatedata(){
       ...
       // val obj = JSONObject(json)
        val callPet = service.getuser("http://glacial.pk/GlacialAppPortalApis/getusers.php")
        callPet.enqueue(object : Callback<List<user>> {
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
                            val customAdapter = CustomAdapteruser(
                                this@UsersList,
                                ob as ArrayList<user>?
