...
public class CustomAdapterChemical extends RecyclerView.Adapter<CustomAdapterChemical.MyViewHolder> {
...
ProgressBar progressBar;
    ...
    public CustomAdapterChemical(Context context, ArrayList<labtestcontents> mainob) {
