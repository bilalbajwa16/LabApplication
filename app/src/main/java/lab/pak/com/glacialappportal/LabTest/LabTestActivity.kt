...
submit.setOnClickListener {
    ...
    val  warning1 = pr?.getString("Labtest",null)


if (warning1!=""){

    notifemail()
  //   Toast.makeText(this@LabTestActivity, "email sent", Toast.LENGTH_SHORT).show()
...
//    Toast.makeText(this@LabTestActivity, e.toString(), Toast.LENGTH_SHORT).show()
    ...
    fun notifemail(){
        ...
        CustomAdapterBiology.getApiClient("http://glacial.pk/api/mailapi.php/")
    }
...
// call the constructor of CustomAdapter to send the reference and data to Adapter
            ...
            override fun onFailure(call: Call<List<labtestcontents>>, t: Throwable) {
                try {
                    ...
                    Toast.makeText(this@LabTestActivity, "Sign in error Please try again!", Toast.LENGTH_SHORT).show()
                } catch (a: Exception) {
                    //progressBar.setVisibility(View.INVISIBLE);
...
// get value from LL Json Object
 ...
 //                             startActivity(o)
             ...
             override fun onFailure(call: Call<Any>, t: Throwable) = try {
                 simpleProgressBar.visibility = View.INVISIBLE
             ...
             //    e.printStackTrace();
              //    Toast.makeText(content,"Failure"+ a.toString(), Toast.LENGTH_LONG).show();
